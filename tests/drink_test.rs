...
mod tests {
    ...
    async fn test_drink_details_with_people() {
        ...
        let drink_detail: DrinkDetail = serde_json::from_slice(&body)
            .expect("Failed to deserialize drink detail");
    ...
    async fn test_get_drinks_list() {
        ...
        let body = test::read_body(resp).await;
        let drinks: Vec<xnote::models::drink::Drink> = serde_json::from_slice(&body)
            .expect("Failed to deserialize drinks list");
    ...
    async fn test_get_drink_by_id_ube_latte() {
        ...
        let body = test::read_body(resp).await;
        let drink: xnote::models::drink::Drink = serde_json::from_slice(&body)
            .expect("Failed to deserialize drink");
            
        assert_eq!(drink.id, ctx.drink1_id);
        assert_eq!(drink.name, "Sip House - Ube Latte");
        assert_eq!(drink.date, chrono::NaiveDate::from_ymd_opt(2024, 1, 15).unwrap());
    ...
    async fn test_get_drink_by_id_homemade_latte() {
        ...
        assert_eq!(drink.date, chrono::NaiveDate::from_ymd_opt(2024, 1, 16).unwrap());
    ...
    async fn test_get_drink_by_id_tea_shop() {
        ...
        assert_eq!(drink.date, chrono::NaiveDate::from_ymd_opt(2024, 1, 17).unwrap());
