...
mod tests {
    ...
    async fn test_event_details_with_people() {
        ...
        let event_detail: EventDetail =
            serde_json::from_slice(&body).expect("Failed to deserialize event detail");
    ...
    async fn test_get_events_list() {
        ...
        let body = test::read_body(resp).await;
        let events: Vec<xnote::models::event::Event> =
            serde_json::from_slice(&body).expect("Failed to deserialize events list");
    ...
    async fn test_get_event_by_id_running() {
        ...
        let body = test::read_body(resp).await;
        let event: xnote::models::event::Event =
            serde_json::from_slice(&body).expect("Failed to deserialize event");
    ...
    async fn test_get_event_by_id_not_found() {
        ...
        let req = test::TestRequest::get().uri("/events/99999").to_request();
