...
mod tests {
    ...
    async fn test_get_restaurants_list() {
        ...
        let restaurants: Vec<xnote::models::restaurant::Restaurant> = serde_json::from_slice(&body)
            .expect("Failed to deserialize restaurants list");
    ...
    async fn test_get_restaurant_by_id_pasta() {
        ...
        let body = test::read_body(resp).await;
        let restaurant: xnote::models::restaurant::Restaurant = serde_json::from_slice(&body)
            .expect("Failed to deserialize restaurant");
