...
mod tests {
    ...
    async fn test_get_people_list() {
        ...
        let people: Vec<xnote::models::people::People> =
            serde_json::from_slice(&body).expect("Failed to deserialize people list");
    ...
    async fn test_get_person_by_id_alice() {
        ...
        let body = test::read_body(resp).await;
        let person: xnote::models::people::People =
            serde_json::from_slice(&body).expect("Failed to deserialize person");
    ...
    async fn test_get_person_by_id_not_found() {
        ...
        let req = test::TestRequest::get().uri("/people/99999").to_request();
